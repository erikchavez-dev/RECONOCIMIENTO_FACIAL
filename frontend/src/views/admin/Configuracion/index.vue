      ...
      <div class="seccion">
        ...
        <div class="form-grid">
          <div class="campo">
            ...
            <div class="time-picker">
              <select v-model="horasEntrada.inicio_h"    class="sel-hora">  <option v-for="h in horas12" :key="h" :value="h">{{ h }}</option></select>
              <span class="sep">:</span>
              <select v-model="horasEntrada.inicio_m"    class="sel-min">   <option v-for="m in minutos" :key="m" :value="m">{{ m }}</option></select>
              <select v-model="horasEntrada.inicio_ampm" class="sel-ampm">  <option value="AM">AM</option><option value="PM">PM</option></select>
            </div>
          ...
          <div class="campo">
            ...
            <div class="time-picker">
              <select v-model="horasEntrada.fin_h"    class="sel-hora">  <option v-for="h in horas12" :key="h" :value="h">{{ h }}</option></select>
              <span class="sep">:</span>
              <select v-model="horasEntrada.fin_m"    class="sel-min">   <option v-for="m in minutos" :key="m" :value="m">{{ m }}</option></select>
              <select v-model="horasEntrada.fin_ampm" class="sel-ampm">  <option value="AM">AM</option><option value="PM">PM</option></select>
            </div>
        ...
        <div class="campo tolerancia-campo">
          ...
          <div class="tolerancia-row">
            <input v-model.number="form.tolerancia_minutos" type="number" min="0" max="120" step="5" class="input-tolerancia" />
            <span class="tolerancia-hint">min. Hasta las <strong>{{ limiteTolerancia }}</strong> se acepta como tardanza.</span>
          </div>
      ...
      <div class="seccion">
        ...
        <div class="form-grid">
          <div class="campo">
            ...
            <div class="time-picker">
              <select v-model="horasSalida.inicio_h"    class="sel-hora">  <option v-for="h in horas12" :key="h" :value="h">{{ h }}</option></select>
              <span class="sep">:</span>
              <select v-model="horasSalida.inicio_m"    class="sel-min">   <option v-for="m in minutos" :key="m" :value="m">{{ m }}</option></select>
              <select v-model="horasSalida.inicio_ampm" class="sel-ampm">  <option value="AM">AM</option><option value="PM">PM</option></select>
            </div>
          ...
          <div class="campo">
            ...
            <div class="time-picker">
              <select v-model="horasSalida.fin_h"    class="sel-hora">  <option v-for="h in horas12" :key="h" :value="h">{{ h }}</option></select>
              <span class="sep">:</span>
              <select v-model="horasSalida.fin_m"    class="sel-min">   <option v-for="m in minutos" :key="m" :value="m">{{ m }}</option></select>
              <select v-model="horasSalida.fin_ampm" class="sel-ampm">  <option value="AM">AM</option><option value="PM">PM</option></select>
            </div>
...
async function guardar() {
  exito.value = ''; errorMsg.value = ''; guardando.value = true
  try {
